...
export const AuthProvider = ({ children }) => {
    ...
    const signin = async (email, password) => {
        try {
            const response = await axios.post("/login", {  // Usando variável de ambiente
                email: email,
                password: password,
            });
    ...
    const signup = async (email, password) => {
        try {
            const response = await axios.post("/register", {  // Usando variável de ambiente
                email: email,
                password: password,
            });
    ...
    const getUbs = useCallback(async () => {
        try {
            const response = await axios.get("/ubs");  // Usando variável de ambiente
    ...
    const getUbsWithVacinas = useCallback(async () => {
        try {
            const response = await axios.get("/ubsWithVacinas");  // Usando variável de ambiente
